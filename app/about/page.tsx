    ...
    <main id="main-content">
      <header className="page-hero dense-page-hero section-shell about-page-hero">
        <div>
          ...
          <h1>Software makes more sense when you understand the system around it.</h1>
        </div>
      ...
      <div className="section-shell inner-page-grid">
        ...
        <div className="inner-page-content">
          <section id="experience" className="dense-content-section" aria-labelledby="experience-title">
            ...
            <h2 id="experience-title">Projects I have built and maintained.</h2>
          ...
          <section id="skills" className="dense-content-section" aria-labelledby="skills-title">
            ...
            <h2 id="skills-title">Technical skills, grouped by experience.</h2>
          ...
          <section id="ai" className="dense-content-section" aria-labelledby="ai-title">
            ...
            <div className="split-content-head">
              <h2 id="ai-title">How I use AI development tools.</h2>
              <div>
          ...
          <section id="outside" className="dense-content-section" aria-labelledby="outside-title">
            ...
            <div className="split-content-head">
              <h2 id="outside-title">Interests outside computing.</h2>
              <div>
                <p>Outside software, I follow aerospace, physics, Formula 1, basketball, soccer, and UFC. I enjoy learning how technical systems and competitive teams improve performance over time.</p>
